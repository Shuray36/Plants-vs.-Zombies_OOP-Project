...
{
	if (nChar == VK_RIGHT) {
		character.SetTopLeft(character.Left() + 10, character.Top() + 0); // Do something...
	}
	if (nChar == VK_LEFT) {
		character.SetTopLeft(character.Left() - 10, character.Top() + 0);
	}
	if (nChar == VK_UP) {
		character.SetTopLeft(character.Left() + 0, character.Top() - 10);
	}
	if (nChar == VK_DOWN) {
		character.SetTopLeft(character.Left() + 0, character.Top() + 10);
	}
